...
require 'bankster/hbci/segments/hiupa'
require 'bankster/hbci/segments/hiupd'
require 'bankster/hbci/segments/hikaz'
require 'bankster/hbci/segments/hkend'
require 'bankster/hbci/segments/hikazs'
require 'bankster/hbci/segments/hisals'
require 'bankster/hbci/segments/unknown'

# Services
require 'bankster/hbci/services/base_receiver'
