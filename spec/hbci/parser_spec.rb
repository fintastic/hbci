...
describe Hbci::Parser do
  ...
  describe '#parse' do
    it 'parses' do
      ...
      expect(described_class.new("eins:zwei+drei'vier+@5@asdsd'").parse).to eql(
        [[%w[eins zwei], ['drei']], [['vier'], ['asdsd']]]
      )

      expect(described_class.new("ei??ns:zwei+drei'vier+@5@asdsd'").parse).to eql(
        [[%w[ei?ns zwei], ['drei']], [['vier'], ['asdsd']]]
      )
    end
  end
end
