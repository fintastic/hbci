...
def stub_dialog_init_response_message(credentials, dialog_id: 'LM6022214510276', rand: '10999990')
  ...
  msg << "HIUPD:53:6:4+#{bank_account_1}::280:#{credentials.bank_code}+#{bank_account_iban_1}+#{credentials.user_id}++EUR+#{owner}++Kontokorrent++HKSAK:1+HKISA:1+HKSSP:1+HKSAL:1+HKKAZ:1+HKEKA:1+HKCDB:1+HKPSP:1+HKCSL:1+HKCDL:1+HKPAE:1+HKAUB:1+HKPPD:1+HKCSA:1+HKCDN:1+HKBMB:1+HKBBS:1+HKDMB:1+HKDBS:1+HKCSB:1+HKCUB:1+HKQTG:1+HKSPA:1+HKDSB:1+HKCCM:1+HKCUM:1+HKCCS:1+HKCDE:1+HKCSE:1+HKDSW:1+HKSAL:1+HKKAZ:1+HKAUB:1+GKVPU:1+GKVPD:1'"
  msg << "HIUPD:54:6:4+#{bank_account_2}::280:#{credentials.bank_code}+#{bank_account_iban_2}+#{credentials.user_id}++EUR+#{owner}++Kontokorrent++HKSAK:1+HKISA:1+HKSSP:1+HKSAL:1+HKKAZ:1+HKEKA:1+HKCDB:1+HKPSP:1+HKCSL:1+HKCDL:1+HKPAE:1+HKAUB:1+HKPPD:1+HKCSA:1+HKCDN:1+HKBMB:1+HKBBS:1+HKDMB:1+HKDBS:1+HKCSB:1+HKCUB:1+HKQTG:1+HKSPA:1+HKDSB:1+HKCCM:1+HKCUM:1+HKCCS:1+HKCDE:1+HKCSE:1+HKDSW:1+HKSAL:1+HKKAZ:1+HKAUB:1+GKVPU:1+GKVPD:1'"
  msg << "HIUPD:55:6:4+#{bank_account_3}::280:#{credentials.bank_code}+#{bank_account_iban_3}+#{credentials.user_id}++EUR+#{owner}++Termineinlage++HKSAK:1+HKISA:1+HKSSP:1+HKSAL:1+HKKAZ:1+HKEKA:1+HKPSP:1+HKCSL:1+HKPAE:1+HKCSA:1+HKBMB:1+HKBBS:1+HKDMB:1+HKDBS:1+HKCSB:1+HKCUB:1+HKQTG:1+HKSPA:1+HKCUM:1+HKCCS:1+HKCSE:1+HKSAL:1+HKKAZ:1+GKVPU:1+GKVPD:1'"
  msg << "HIUPD:56:6:4+#{bank_account_4}::280:#{credentials.bank_code}+#{bank_account_iban_4}+#{credentials.user_id}++EUR+#{owner}++Termineinlage++HKSAK:1+HKISA:1+HKSSP:1+HKSAL:1+HKKAZ:1+HKEKA:1+HKPSP:1+HKCSL:1+HKPAE:1+HKCSA:1+HKBMB:1+HKBBS:1+HKDMB:1+HKDBS:1+HKCSB:1+HKCUB:1+HKQTG:1+HKSPA:1+HKCUM:1+HKCCS:1+HKCSE:1+HKSAL:1+HKKAZ:1+GKVPU:1+GKVPD:1'"
  msg << "HIUPD:57:6:4+#{bank_account_5}::280:#{credentials.bank_code}+#{bank_account_iban_5}+#{credentials.user_id}++EUR+#{owner}++Kreditkartenkonto++HKSAK:1+HKISA:1+HKSSP:1+HKSAL:1+HKKAZ:1+HKEKA:1+HKPSP:1+HKPAE:1+HKQTG:1+HKSPA:1+HKSAL:1+HKKAZ:1+GKVPU:1+GKVPD:1'"
  msg << "HIUPD:58:6:4+#{bank_account_6}::280:#{credentials.bank_code}+#{bank_account_iban_6}+#{credentials.user_id}++EUR+#{owner}++Sparkonto++HKSAK:1+HKISA:1+HKSSP:1+HKSAL:1+HKKAZ:1+HKEKA:1+HKPSP:1+HKPAE:1+HKQTG:1+HKSPA:1+HKSAL:1+HKKAZ:1+GKVPU:1+GKVPD:1'"
  msg << "HIUPD:59:6:4+#{bank_account_7}::280:#{credentials.bank_code}+#{bank_account_iban_7}+#{credentials.user_id}++EUR+#{owner}++Gesch\xE4ftsanteile++HKSAK:1+HKISA:1+HKSSP:1+HKSAL:1+HKKAZ:1+HKEKA:1+HKPSP:1+HKPAE:1+HKQTG:1+HKSPA:1+HKSAL:1+HKKAZ:1+GKVPU:1+GKVPD:1'"
  msg << "HNSHA:60:2+#{rand}''"
  msg << "HNHBS:61:1+1'"
  msg.join
end
...
def stub_transactions_v6_request_message(credentials, account_number: '11111111', dialog_id: 'LM6022214510276', rand: '10999990', start_date: Date.new(2016, 2, 18), end_date: Date.new(2016, 2, 20))
  ...
  payload = %W(
    HNSHK:2:4+PIN:1+942+#{rand}+1+1+1::0+1+1:#{date}:#{time}+1:999:1+6:10:16+280:#{credentials.bank_code}:#{credentials.user_id}:S:0:0'
    HKKAZ:3:6+#{account_number}::280:#{credentials.bank_code}+N+#{start_date.strftime('%Y%m%d')}+#{end_date.strftime('%Y%m%d')}'
    HNSHA:4:2+#{rand}++#{credentials.pin}'
  )
